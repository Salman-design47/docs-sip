---
title: NEAR Integration Design
description: Design document for integrating NEAR 1Click API with SIP Protocol SDK
---
...
- [NEAR 1Click API Reference](/integrations/near-1click-api) - Full API documentation
- [NEAR Privacy Analysis](/integrations/near-privacy-analysis) - Privacy threat model
- [SIP Specification](/specs/sip-spec) - Protocol specification
